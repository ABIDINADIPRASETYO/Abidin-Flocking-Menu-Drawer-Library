package com.example.abidinflockingmenudrawer;
...
import com.example.abidinflockingmenulib.TabDrawer;
import com.example.abidinflockingmenulib.model.Tab;
import com.example.abidinflockingmenulib.model.TabDrawerData;
import com.example.abidinflockingmenulib.model.TabListItem;


public class BaseActivity extends AppCompatActivity {

    /*https://github.com/ashazar/TabDrawer*/
    /*https://github.com/ashazar/TabDrawer*/
    /*https://github.com/ashazar/TabDrawer*/
    Context context;
    Activity activity;
    ...
    private TabDrawerData prepareTabArray() {
        return new TabDrawerData()
                ...
                .addTab( new Tab()
                        ...
                        .addTabListItem( new TabListItem("Menu Nol", R.drawable.ic_add_box_white_24dp ) )
                        .addTabListItem( new TabListItem("Menu Siji", R.drawable.ic_archive_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Loro", R.drawable.ic_delete_forever_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Telu", R.drawable.ic_add_box_white_24dp ) )
                        .addTabListItem( new TabListItem("Menu Papat", R.drawable.ic_archive_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Limo", R.drawable.ic_delete_forever_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Enem", R.drawable.ic_archive_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Pitu", R.drawable.ic_add_box_white_24dp ) )
                        .addTabListItem( new TabListItem("Menu Wolu", R.drawable.ic_delete_forever_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Songo", R.drawable.ic_archive_white_24dp) )
                )
                ...
                .addTab( new Tab()
                        ...
                        .setDrawerListColumnNumber(2)
                        .addTabListItem( new TabListItem("Menu Nol", R.drawable.ic_face_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Siji", R.drawable.ic_person_add_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Loro", R.drawable.ic_people_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Telu", R.drawable.ic_sentiment_very_satisfied_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Papat", R.drawable.ic_person_add_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Limo", R.drawable.ic_face_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Enem", R.drawable.ic_sentiment_very_satisfied_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Pitu", R.drawable.ic_people_white_24dp) )
                )

                .addTab( new Tab()
                        .setTitle("Tab Telu")
                        .setIconImage(R.drawable.n_report)
                        .addTabListItem( new TabListItem("Menu Nol", R.drawable.ic_event_available_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Siji", R.drawable.ic_event_busy_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Loro", R.drawable.ic_feedback_white_24dp) )
                        .addTabListItem( new TabListItem("Menu Telu", R.drawable.ic_description_white_24dp) )
                )

                .addTab( new Tab()
                        .setTitle("Pengaturan")
                        .setIconImage(R.drawable.n_settings)
                        .addTabListItem( new TabListItem("Pengaturan Nol", R.drawable.ic_settings_white_24dp) )
                        .addTabListItem( new TabListItem("Pengaturan Siji", R.drawable.ic_lock_white_24dp) )
                        .addTabListItem( new TabListItem("Pengaturan Loro", R.drawable.ic_accessibility_white_24dp) )
                        .addTabListItem( new TabListItem("Pengaturan Telu", R.drawable.ic_notifications_white_24dp) )
                        .addTabListItem( new TabListItem("Pengaturan Papat", R.drawable.ic_collections_bookmark_white_24dp) )
                        .addTabListItem( new TabListItem("Pengaturan Limo", R.drawable.ic_folder_shared_white_24dp) )
                        .addTabListItem( new TabListItem("Pengaturan Enem", R.drawable.ic_cast_white_24dp) )
                        .addTabListItem( new TabListItem("Pengaturan Pitu", R.drawable.ic_apps_white_24dp) )
                );
